...
<table border="1">
	...
	<tr>
		<td>회원명</td>
		<td>
			<select name="cname" onchange="findNum(this.value)">
				<option value="">회원명
				<option value="10001">홍길동
				<option value="10004">장발장
	...
	<tr>
		<td>회원번호</td>
		<td><input type="text" name="cno" value="" readonly>예)10001</td>
	</tr>
	<tr>
		<td>강의장소</td>
		<td>
	...
	<tr>
		<td>강의명</td>
		<td>
			<select name="class_name" onchange="findTuition(this.value)">
				<option value="">강의신청
